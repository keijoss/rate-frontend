...
function useQueryAllPosts() {
    ...
    const allPosts = [
        ...
        },
        {
            ...
            teacher: "Mrs. Wilson",
            subject: "Art",
            comment: "The teacher is very creative and encourages us to express ourselves through various art forms.",
            teaching_methods: 4,
            communication: 4,
            supportiveness: 3,
            organization: 3,
        ...
        },
        {
            ...
            comment: "The teacher keeps the class active and fun. We always have a great time during PE.",
            teaching_methods: 3,
            communication: 4,
            supportiveness: 5,
            organization: 3,
        ...
        },
        {
            ...
            teacher: "Mr. Brown",
            subject: "English",
            comment: "The teacher is very knowledgeable and provides great explanations. I enjoy the class.",
            teaching_methods: 5,
            communication: 5,
            supportiveness: 4,
            organization: 4,
        ...
        },
        {
            ...
            teacher: "Ms. Davis",
            subject: "History",
            comment: "The teacher makes the subject come alive with interesting stories and interactive activities.",
            teaching_methods: 4,
            communication: 3,
            supportiveness: 5,
            organization: 4,
